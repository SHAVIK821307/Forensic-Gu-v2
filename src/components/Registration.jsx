...
export default function RegistrationCharges() {
  ...
  return (
    ...
    >
      {/* Pink overlay */}
      <div className="absolute inset-0 bg-[#5E5CE8]/70 backdrop-blur-sm" />
          ...
          {registrationOptions.map((option) => (
            <div key={option.type} className="backdrop-blur-sm bg-white/10 rounded-2xl border border-white">
              <div className="p-6 flex flex-col items-center text-center text-white space-y-4">
                ...
                <a href="https://forms.gle/MfUi6M6eSMsX7nMt5" target="_blank"  className="bg-white hover:bg-gray-200  text-[#5779FF] font-bold rounded-2xl p-4 w-full">
                  REGISTER
                </a>
              </div>
            </div>
